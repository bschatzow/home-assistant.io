...
You need to go to https://console.developers.google.com/apis/credentials/consent and make sure the project is published.  Without this you will not have access to it in Home Assistant
